...
class RegistrationForm(forms.Form):
    ...
    email      = forms.CharField(max_length=50, label=_('E-mail'),
    ...
    def clean(self):
        ...
        if password1 and password2 and password1 != password2:
            raise forms.ValidationError(ugettext('Passwords did not match.'))
    ...
    def clean_username(self):
        ...
        if User.objects.filter(username__exact=username):
            raise forms.ValidationError(ugettext('Username is already taken.'))
